...
\todo[inline]{Graphenstruktur erklären}
\todo[inline]{Graphenstruktur-Quelle einfügen}
\todo[inline]{Auswertung 5.2 hinzufügen}
\todo[inline]{Ergebnisse zu Ende}
\todo[inline]{Diskussion}
...
\todo[inline]{Kategorie 5.1 fehlt!}
...
\todo[inline]{Hatten wir hier schon zwischen Gruppen getrennt was analysiert?}
\todo[inline]{Was ist mit EFFEKTSTÄRKEN??}
...
\clearpage
\appendix
\numberwithin{figure}{section} %Nummerierung beginnt im App. bei 1
